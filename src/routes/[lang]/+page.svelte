		...
		<div class="container mx-auto px-4 py-8">
				...
				<div class="dropdown dropdown-end">
					...
					>
						{#each Object.keys(languages) as langCode (langCode)}
							{#if langCode !== lang}
								<li>
									<a href={`/${langCode}`} class="btn btn-ghost justify-start"
			...
			<div class="max-w-5xl mx-auto">
				...
				{#if currentConversionInfo?.title}
					<div class="card bg-base-100 mb-8" in:fade={{ duration: 300 }} key={activeTab}>
						<div class="card-body">
					...
					{#if displayedFiles.length > 0}
						<div class="mb-4">
							...
							<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
								{#each displayedFiles as file, i (file.originalFile?.name + i + file.format)}
